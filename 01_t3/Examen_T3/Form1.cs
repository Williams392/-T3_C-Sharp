...
namespace Examen_T3
{
    ...
    {
        List<Mascota_Dueño> LstDueños = new List<Mascota_Dueño>();  // Declarar una lista (Modulo 9)
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Edad = comboBox1.SelectedIndex;
            Raza = comboBox1.Text;

            //Nombre = comboBox1.SelectedIndex;
            //Raza = comboBox1.SelectedIndex;


            switch (Edad)
            {
                case 0: IBIedad.Text = "3 años"; break;
                case 1: IBIedad.Text = "2 años"; break;
                case 2: IBIedad.Text = "4 años"; break;
                case 3: IBIedad.Text = "7 años"; break;
                default: IBIedad.Text = "12 años"; break;
            }
            switch (Raza)
            {
                case "Pastor Aleman": IBIraza.Text = "Pastor Aleman"; break;
                case "Mastín Tibetano": IBIraza.Text = "Mastín Tibetano"; break;
                case "Bulldog Frances": IBIraza.Text = "Bulldog Frances"; break;
                case "American bully": IBIraza.Text = "American Bully"; break;
                default: IBIraza.Text = "Pitbull"; break;
            }
        }

        private void button1_Click(object sender, EventArgs e) // -> Boton Registrar
        {
            Mascota_Dueño oDueños = new Mascota_Dueño(); // Rehusando la class (Dueños.cs)


            oDueños.nombre = txtNombre.Text;
            oDueños.direccion = txtDireccion.Text;
            oDueños.DNI = txtDNI.Text;
            oDueños.telefono = txtTelefono.Text;
            oDueños.Nombre_M = txtNombre2.Text;
            oDueños.Raza = IBIraza.Text;
            oDueños.edad = IBIedad.Text;

            LstDueños.Add(oDueños);
            // (Modulo_8) Exepciones
            MessageBox.Show("Se registro con Éxito");    // -> Mensaje en pantalla
        }
        ...
        public void MostrarLista()
        {
            ...
            foreach (Mascota_Dueño item in LstDueños)
            {
                //MessageBox.Show(item.nombre);        // -> Mensaje en pantalla
                //MessageBox.Show(item.direccion);
                MessageBox.Show(item.Nombre_M);
